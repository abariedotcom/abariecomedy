        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center mb-16">
            ...
            <p className="text-dark-400 text-lg max-w-2xl mx-auto">
              Catch Abarie live on stage! From intimate comedy clubs to massive arenas,
      ...
      <section className="py-16 px-4 bg-dark-900">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 mb-10">
            ...
            <h2 className="font-display text-3xl font-bold">Featured Shows</h2>
          </div>
                ...
                <div className="lg:flex">
                  ...
                  <div className="lg:w-1/2 p-6 flex flex-col">
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      ...
                      <button className="px-5 py-2 bg-primary-500 hover:bg-primary-600 text-dark-950 font-semibold rounded-lg transition-colors flex items-center gap-2">
      ...
      <section className="py-16 px-4 bg-dark-950">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 mb-10">
            ...
            <h2 className="font-display text-3xl font-bold">All Shows</h2>
          </div>
                ...
                <div className="aspect-video overflow-hidden relative">
                  ...
                  {!event.available && (
                    <div className="absolute inset-0 bg-dark-950/70 flex items-center justify-center">
                      <span className="px-4 py-2 bg-dark-800 text-dark-300 font-semibold rounded-lg">Coming Soon</span>
                    </div>
                  )}
                </div>
