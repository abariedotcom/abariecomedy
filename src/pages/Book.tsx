...
export default function Book() {
          ...
          <div className="max-w-lg w-full mx-auto text-center px-4 relative">
            <div className="bg-dark-900/50 rounded-2xl p-8 sm:p-12 border border-dark-700">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  onClick={() => { setIsSuccess(false); setFormData(initialForm); }}
  ...
  return (
    <div className="min-h-screen bg-dark-950 text-white font-sans">
      ...
      <section className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl font-bold mb-6">
            Book For Your <span className="text-primary-400">Event</span>
          </h1>
      ...
      {/* Back to Home */}
      <section className="py-8 bg-dark-900 border-t border-dark-800">
