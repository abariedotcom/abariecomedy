            ...
            <div className="lg:col-span-3">
              {isSuccess ? (
                <div className="bg-dark-800/50 rounded-2xl p-8 sm:p-12 border border-dark-700 text-center">
                  ...
                  <button onClick={handleReset} className="px-6 py-3 bg-primary-500 hover:bg-primary-400 text-dark-950 font-semibold rounded-lg transition-all">
                ...
                <div className="bg-dark-800/50 rounded-2xl p-6 sm:p-8 border border-dark-700">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid sm:grid-cols-2 gap-5">
                      <div>
                        <label className="block text-dark-200 text-sm font-medium mb-2">First Name <span className="text-accent-500">*</span></label>
                        <div className="relative">
                          <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-dark-500" />
                          <input type="text" name="firstName" value={formData.firstName} onChange={handleInputChange} required placeholder="John" className="w-full pl-12 pr-4 py-3 bg-dark-800 border border-dark-600 rounded-lg text-white placeholder-dark-400 focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all" />
                        </div>
                      </div>
                      <div>
                        <label className="block text-dark-200 text-sm font-medium mb-2">Last Name <span className="text-accent-500">*</span></label>
                        <div className="relative">
                          <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-dark-500" />
                          <input type="text" name="lastName" value={formData.lastName} onChange={handleInputChange} required placeholder="Smith" className="w-full pl-12 pr-4 py-3 bg-dark-800 border border-dark-600 rounded-lg text-white placeholder-dark-400 focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all" />
                        </div>
                      </div>
                    </div>

                    <div>
                      <label className="block text-dark-200 text-sm font-medium mb-2">Email Address <span className="text-accent-500">*</span></label>
                      <div className="relative">
                        <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-dark-500" />
                        <input type="email" name="email" value={formData.email} onChange={handleInputChange} required placeholder="john@example.com" className="w-full pl-12 pr-4 py-3 bg-dark-800 border border-dark-600 rounded-lg text-white placeholder-dark-400 focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all" />
                      </div>
                    </div>

                    <div>
                      <label className="block text-dark-200 text-sm font-medium mb-2">Your Enquiry <span className="text-accent-500">*</span></label>
                      <textarea name="enquiry" value={formData.enquiry} onChange={handleInputChange} required rows={6} placeholder="Tell us how we can help you..." className="w-full px-4 py-3 bg-dark-800 border border-dark-600 rounded-lg text-white placeholder-dark-400 focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all resize-none" />
                    </div>
            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+2348012345678" className="text-white font-medium hover:text-primary-400 transition-colors">+234 801 234 5678</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:contact@abarie.com" className="text-white font-medium hover:text-primary-400 transition-colors">contact@abarie.com</a>
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-r from-primary-600/20 to-accent-500/10 rounded-2xl p-6 border border-primary-500/30">
                ...
                <div className="space-y-3">
                  <Link to="/about" className="flex items-center gap-2 text-dark-200 hover:text-primary-400 transition-colors"><ArrowRight size={16} />About Abarie</Link>
                  <Link to="/events" className="flex items-center gap-2 text-dark-200 hover:text-primary-400 transition-colors"><ArrowRight size={16} />Upcoming Events</Link>
                  <Link to="/tickets" className="flex items-center gap-2 text-dark-200 hover:text-accent-400 transition-colors"><ArrowRight size={16} />Get Tickets</Link>
                  <a href="/#book" className="flex items-center gap-2 text-dark-200 hover:text-primary-400 transition-colors"><ArrowRight size={16} />Book Abarie</a>
                </div>
              </div>

              <div className="relative rounded-2xl overflow-hidden h-48">
                <img src="https://images.pexels.com/photos/2747449/pexels-photo-2747449.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="Comedy show" className="w-full h-full object-cover" />
      ...
      <section className="py-8 px-4 bg-dark-900 border-t border-dark-800">
        <div className="max-w-7xl mx-auto text-center">
          <Link to="/" className="inline-flex items-center gap-2 text-primary-400 hover:text-primary-300 font-semibold transition-colors">
            <ArrowRight size={20} className="rotate-180" />Back to Homepage
          </Link>
        </div>
      </section>
